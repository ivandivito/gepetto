...
IDLE_RUN:
	...
	MOV TEMP_2, GGR_REG
	ANDI TEMP_2, (1<<SFF) ;Si hay archivo guardado
	BREQ IDLE_TEST_CONFIRM
...
IDLE_GRBL_PROCESS_LINE:
	...
	BREQ IDLE_GRBL_PROCESS_END

		CHANGE_STATE STATE_ERROR

	IDLE_GRBL_PROCESS_END:
...
IDLE_USB_PROCESS_LINE:
	...
	;Definir si usar TICK y timeout
