...
.EQU SOFT_UART_TX_PORT = PORTA
.EQU SOFT_UART_TX_DDR = DDRA
.EQU SOFT_UART_RX_PIN = PIND
.EQU SOFT_UART_RX_DDR = DDRD

.EQU SOFT_UART_ISC0 = ISC00
.EQU SOFT_UART_ISC1 = ISC01

.EQU SOFT_UART_INT = INT0
...
.EQU SOFT_UART_TCCR = TCCR0
.EQU SOFT_UART_OCR = OCR0
.EQU SOFT_UART_OCF = 1
...
SOFT_UART_INIT:
	...
	CLR TEMP
	OUT SOFT_UART_TCNT, TEMP ;Limpia el timer
	...
	OUT GICR, TEMP ;Habilitar interrupcion
...
SOFT_UART_SEND_BYTE:
	...
	LDI TEMP, (1<<WGM01)|SOFT_UART_CS
	OUT SOFT_UART_TCCR, TEMP ;Timer en modo comparar y limpiar, comenzar a contar
...
SEND_CONTINUE:
	...
	LDI TEMP, (1<<WGM01)
	OUT SOFT_UART_TCCR, TEMP ;Detiene el timer
...
SAMPLE_LOOP:
	...
	IN TEMP, TIFR
	ORI TEMP, 1<<SOFT_UART_OCR
	OUT TIFR, TEMP ;Limpiar flag
