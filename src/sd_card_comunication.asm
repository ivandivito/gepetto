...
; escribe una linea en la SD apartir de lo apuntado por Z en programa
.DEF TEMP = R16
.DEF SD_CMD_REG = R2
.DEF SD_TX_CMD_ARG_REG_0 = R3
.DEF SD_TX_CMD_ARG_REG_1 = R4
...
SD_TX_P_LINE:
	...
	SD_TX_P_LINE_TX_CMD_W_1:
		CALL SPI_RX
		CPI SPI_IN_OUT_REG,0x00
		BREQ SD_TX_P_LINE_TX_CMD_W_1
	...
	SD_TX_P_LINE_TX:
		...
		POP TEMP ; recupero caracter
		CPI TEMP,'\n'
		BREQ SD_TX_P_LINE_END

		JMP SD_TX_P_LINE_LOOP
